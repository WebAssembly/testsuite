...
(module
  ...
  (func (export "type-f64-i32") (result f64 i32) (call_indirect $out-f64-i32 (i32.const 23)))
  ...
  (func (export "type-all-f64-i32") (result f64 i32)
    (call_indirect $out-f64-i32 (i32.const 23))
  )
  (func (export "type-all-i32-f64") (result i32 f64)
    (call_indirect $over-i32-f64 (i32.const 1) (f64.const 2) (i32.const 24))
  )
  (func (export "type-all-i32-i64") (result i64 i32)
    (call_indirect $swap-i32-i64 (i32.const 1) (i64.const 2) (i32.const 25))
  )
